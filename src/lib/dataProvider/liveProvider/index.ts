...
import { genereteUseListSubscription, genereteUseManySubscription, genereteUseOneSubscription } from '../utilities'
...
export const liveProvider = (client: Client): LiveProvider => {
  return {
    subscribe: ({ callback, params }) => {
      const { resource, meta, pagination, sorters, filters, subscriptionType, id, ids } = params ?? {}
